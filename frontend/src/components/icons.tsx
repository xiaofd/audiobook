// 轻量 SVG 图标组件（避免引入 lucide-react 依赖，保持轻量）
...
export function PrevIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
// 快退 N 秒（带循环箭头 + 数字角标由调用方渲染）
export function RewindIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function VolumeXIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
...
export function BookCoverFallback({ className = 'w-10 h-10' }: IconProps) {
  return (
...
// 章节列表（队列抽屉入口）
export function QueueIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <line x1="4" y1="6" x2="20" y2="6" />
      <line x1="4" y1="12" x2="14" y2="12" />
      <line x1="4" y1="18" x2="14" y2="18" />
      <polygon points="17 14 22 17.5 17 21" fill="currentColor" stroke="none" />
    </svg>
  );
}
...
// 播放中的均衡器动效（当前章节指示）
export function BarsIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
